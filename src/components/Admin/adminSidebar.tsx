...
export const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: "/admin/users",
      subItems: [
        { name: "Olive  Users", path: "/admin/users" },
                ...
                {item.subItems ? (
                  <>
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3 rounded-lg hover:bg-orange-50 text-gray-700 hover:text-orange-400 transition-colors ${expandedMenus[item.name.toLowerCase()] ? 'bg-green-50 text-orange-400' : ''
                        }`}
                    >
                      ...
                      <ul className={`${collapsed ? 'ml-2' : 'ml-8'} mt-1 space-y-1`}>
                        {item.subItems.map((subItem) => (
                          <li key={subItem.name}>
                            <Link
                              to={subItem.path}
                              activeProps={{ className: 'text-orange-400 font-medium' }}
            ...
            <>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Olivegrocerystores.com</p>
                </div>
              </div>
