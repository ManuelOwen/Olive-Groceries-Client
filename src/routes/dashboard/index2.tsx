...
// import { UserDashboardContent } from '@/components/user/UserDashboardContent';export const Route = createFileRoute('/dashboard/index2')({

// import { isAdmin, isUser, isDriver, getUserData } from '@/lib/utils';  component: RouteComponent,

// })

// function DashboardIndex() {

//   const userData = getUserData();function RouteComponent() {

//   return <div>Hello "/dashboard/index2"!</div>
